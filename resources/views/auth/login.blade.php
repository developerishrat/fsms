          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              <div class="brand-logo">
                <img src="{{ asset('master_dashboard/images/logo.svg') }}">
              </div>
              ...
              <form  action="{{ route('login') }}" method="POST" class="pt-3">
                ...
                <div class="text-center mt-4 font-weight-light"> Don't have an account? <a href="{{ url('register') }}" class="text-primary">Register Now</a>
                </div>
              </form>
            </div>
          </div>
